...
import pandas as pd
from Jira_import import extract_scenarios_and_titles_description
...
user_paths = {
    'jira_url': 'https://geniatestcase-talan.atlassian.net',  # Replace with your Jira URL
    'jira_user': 'farah.oueslati@talan.com',  # Replace with your Jira username
    'project_key': 'SP',  # Replace with your Jira project key
    'ticket_name_field': 'Scenarios',  # Replace with your desired status
}

# Sample DataFrame for testing
data = {
    'id_US': ['PROJ-123', 'PROJ-124'],  # Replace with actual Jira issue keys
    'Test Cases': [
...
# Debugging print for the DataFrame
...
# Retrieve the JIRA_TOKEN from the environment
jira_token = os.getenv("JIRA_TOKEN")

# Debugging: Check if JIRA_TOKEN is set correctly
...
create_link_tickets(user_paths, df_res, link_type="Relates")
