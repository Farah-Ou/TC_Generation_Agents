...
async def upload_files(
    ...
    jira_api_token: Optional[str] = Form(""),
    ...
    try:
        ...
        Create_Graph_folder(True,True, Graphs_folder_path, graph_context, ctx_folder, output_folder, Contxt_Visual_graph_folder)
        ...
        # Save to Jira
        # create_link_tickets(user_paths, df_resultat, ticket_name_field="NEW_TEST", link_type="Relates")
        logging.info("Jira tickets created successfully.")
...
#     Final_output_path = os.path.join(save_output_folder, "image.png")  # Adjust the filename
#     if os.path.exists(Final_output_path):
#         return FileResponse(
#             path=Final_output_path,
#             media_type="image/png",  # Set the correct MIME type for PNG
#             filename="image.png",  # Filename for the downloaded file
#             headers={"Cache-Control": "no-cache"}  # Optional: control caching behavior
#         )
...
# @app.get("/download/")
# async def download_file():
#     filename = "output_files/Gen_TC.xlsx"
#     if os.path.exists(filename):
#         return FileResponse(
#             filename,
#             media_type="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
#             filename="Gen_TC.xlsx"
#         )
#     return JSONResponse(content={"message": "File not found"}, status_code=404)
